...
/**
 * Extends the standard theme with a simple template.
 * 
 * @package   theme_base
 * @subpackage standard
...
$THEME->parents_exclude_sheets  = array(
    'standard'=>array('css3','dock','pagelayout') //We don't want these
);
$THEME->sheets = array(
    'simple',
    'fluid'
...
$THEME->javascripts = array('fontsize_header');
$THEME->javascripts_footer = array('fontsize_footer'); //Includs the fontsize javascript